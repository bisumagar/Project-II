...
import { FilterData, SingleFilterData } from './FilterData'
...
export default function Product() {
  ...
  // from Redux: state.product = { products, product, totalPages, loading, error }
  ...
  const hasActiveFilters = !!(colorValue || sizeValue || priceValue || discount || stock)
            ...
            <div className="grid grid-cols-1 gap-x-8 gap-y-10 lg:grid-cols-5">
             ...
             <div className="flex items-center gap-2">
              ...
              <form className="hidden lg:block">
                ...
                {SingleFilterData.map((section) => (
                  <Disclosure key={section.id} as="div" className="border-b border-gray-200 py-6 ">
                    <div>
                    <h3 className="-my-3 flow-root">
                      <DisclosureButton className="group flex w-full  bg-white py-3 text-sm text-gray-400 hover:text-gray-500">
